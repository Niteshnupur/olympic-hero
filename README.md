...
### Learnings from the project
 ...
 After completing this project, i have have a better understanding of data handling with python(pandas). In this project, i am applying the following concepts :
...
### Approach taken to solve the problem
 ...
 I always watch an Olympic games (my fav part :- Hussain bolt's all racing and Michael Phillips swimming competition's) bt i never work on the Olympic games dataset before this.
so this is great opportunity for me to work on this dataset.
...
### Additional pointers
 ...
 This Olympic games dataset is very interesting to work with.
